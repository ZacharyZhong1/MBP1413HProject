# -*- coding: utf-8 -*-
"""Copy of MBP1413HProject.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1575ioexAWbFkZ2GPL5Tpm8pC7dIVgDtA
...
# standard PyTorch program style: create AutoEncoder, DiceLoss and Adam optimizer
model = AutoEncoder(
    spatial_dims=2,
    in_channels=1,
    out_channels=1,
...
torch.save(
    model,
    os.path.join(root_dir, "my_model_highSNR.pt"),
)
...
model=torch.load(os.path.join(root_dir, "my_model_highSNR.pt"))
model.eval()
